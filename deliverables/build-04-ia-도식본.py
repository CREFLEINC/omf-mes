...
BANDS = [
 ...
 ('공통 (CO)', '계정 · 권한 · 알림 · 대시보드 · 설정 — 셸에 상시',
  '§3-1 시스템/공통 · §5-1 진입',
  {'web': ['W-CO-01', 'W-CO-02', 'W-CO-03', 'W-CO-04', 'W-CO-05', 'W-CO-06', 'W-CO-08', 'W-CO-09', 'W-CO-10'],
   'pop': [], 'mob': ['M-CO-01']}),
...
EXPECT = {
    'prog': {'web': 73, 'pop': 22, 'mob': 19},
    'dom':  {'01': 25, '02': 24, '03': 5, '04': 18, '05': 17, '06': 14, 'CO': 11},
    'conf': {'확정': 85, '추정': 27, '미정': 2},
}
TOTAL = len(ROWS)
...
VERSION_FLOW = [('원 열거', 120, ''), ('중복 8 병합', 112, 'v1.0'), ('적대 검증', 112, 'v1.1'),
                ...
                ('출하 2단 확정', 113, 'v1.8'), ('DR-002 비밀번호 변경', 114, 'v2.0')]
