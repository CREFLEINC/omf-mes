...
if __name__ == '__main__':
    main(sys.argv[1], sys.argv[2],
         ...
         '프로그램별 화면 목록 · IA',
         '관리웹·POP·모바일 3종의 화면 인벤토리 108건과 프로그램별 정보 구조(IA). v1.5 — 화면 상세 스펙 확대 1차 반영: W-06-13 검사정책 설정을 W-06-02로 통합·폐지(109→108) · W-06-03이 원인코드 흡수·손실사유코드는 W-06-06 이관.',
         [('108', '화면<br>관리웹67·POP22·모바일19'),
          ('3', '프로그램<br>(IA 모델 3종)'),
          ('82', '확정<br>(추정24·미정2)'),
