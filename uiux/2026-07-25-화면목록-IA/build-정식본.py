...
if __name__ == '__main__':
    main(sys.argv[1], sys.argv[2],
         ...
         '프로그램별 화면 목록 · IA',
         '관리웹·POP·모바일 3종의 화면 인벤토리 113건과 프로그램별 정보 구조(IA). 2026-08-07 — LOT 상태 4값 확정 반영(정상·불량·검사 대기·폐기). 수치는 deliverables/verify-screen-inventory.py 실측.',
         [('113', '화면<br>관리웹72·POP22·모바일19'),
          ('3', '프로그램<br>(IA 모델 3종)'),
          ('84', '확정<br>(추정27·미정2)'),
          ('87', '상세 스펙 완료<br>/ 113')])
