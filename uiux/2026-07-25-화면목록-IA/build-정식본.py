...
<header class="doc-cover">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><th>작성일</th><td>2026-07-25 (v1.2 개정 2026-07-29)</td></tr>
      <tr><th>버전</th><td>v1.2</td></tr>
...
if __name__ == '__main__':
    main(sys.argv[1], sys.argv[2],
         ...
         '프로그램별 화면 목록 · IA',
         '관리웹·POP·모바일 3종의 화면 인벤토리 113건과 프로그램별 정보 구조(IA). 2계층 매핑 4단계 사람 확정을 반영한 v1.2.',
         [('113', '화면<br>관리웹73·POP22·모바일18'),
          ('3', '프로그램<br>(IA 모델 3종)'),
          ('82', '확정<br>(추정28·미정3)'),
