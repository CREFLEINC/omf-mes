...
STAGES = [
 ...
 ('적치·보관', '01', {'mob':['M-01-04','M-01-05','M-01-07'], 'pop':[], 'web':['W-01-07','W-01-08']}),
 ...
 ('생산 실행', '02', {'mob':['M-02-01','M-02-02'], 'pop':['P-CO-01','P-02-01','P-02-02','P-02-03','P-02-04','P-02-06','P-02-10','P-02-11','P-02-12'], 'web':['W-02-08','W-02-09']}),
 ...
 ('출하',      '04', {'mob':['M-04-01'], 'pop':['P-04-01','P-04-02'], 'web':['W-04-01','W-04-02','W-04-04','W-04-05','W-02-05']}),
]
# 흐름 밖 — 예외·역방향·지원
BANDS = [
...
TREE = [
 ...
 ('출하',     [('출하 지시·확정', ['W-04-01','W-04-02','W-04-03','W-04-04','W-04-05']),
              ('반품·재고', ['W-04-06','W-04-11','W-04-07','W-04-08','W-04-10','W-04-09'])]),
 ...
 ('시스템/공통', [('계정·권한', ['W-CO-01','W-CO-02']), ('알림·공지', ['W-CO-03','W-CO-04']),
              ('설정', ['W-CO-06','W-CO-07']), ('경영 대시보드', ['W-CO-05'])]),
]
tree_html = ''.join(
...
TILES = [('📦','입하',['M-01-01','M-01-02','M-01-06']), ('📥','적치',['M-01-04','M-01-05','M-01-07']),
         ...
         ('🏭','생산 이동/수리',['M-02-01','M-02-02']), ('🚚','출하 스캔',['M-04-01','M-04-03']),
         ('🛠','설비',['M-05-01','M-05-02'])]
...
<h1>화면 목록 · IA 도식본</h1>
<p class="sub">CREFLE · OMF MES UI/UX · <b>v1.2</b> (2026-07-29) · 내부 대외비<br>
...
⑥은 v1.2 변동, ⑦은 전체 목록이다. <span class="chip web new"><b>보라 테두리</b></span>는 v1.2 신설 화면.</div>
...
DOC.write('<tr><th>합계</th>%s<td class="tot">115</td></tr></tbody></table></div>' % mtot)
...
DOC.write('''<h2>⑥ v1.2 변동 <small>2계층 매핑 4단계 사람 확정의 결과</small></h2>
