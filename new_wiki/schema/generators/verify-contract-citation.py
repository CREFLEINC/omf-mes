...
CONTRACT = os.path.join(ROOT, 'new_wiki', 'wiki', 'decisions-policy', '공유계약.md')
DSGAP = os.path.join(ROOT, 'new_wiki', 'raw', 'process', 'uiux', '화면상세스펙-공통', 'ds-gap.md')
UIUX = os.path.join(ROOT, 'new_wiki', 'wiki', 'screens')
