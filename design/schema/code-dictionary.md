...
| `CD-LOT-STATUS-EVENT-SOURCE-DOCUMENT-TYPE` | `INSPECTION_RESULT` `LOT_HOLD` `NONCONFORMANCE` | — | `sourceDocumentTypeCode` | `enum` | 1 | 계약이 `enum` 으로 닫은 값 — `LotStatusHistoryEvent`(`logistics-01자재창고`). ⭐ 전이 9종에서 도출했다(`W-03-01` §5-1 표) — 대응표는 «설계»가 정한다(`A-10` 규칙 1) |
