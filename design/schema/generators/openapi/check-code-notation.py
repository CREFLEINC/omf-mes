...
# ⚠ 2026-09-04 · 4회차 — 488 → 487. 줄면 낮춘다(래칫 규약). `#352`·`#402` 반영에서
#    새로 적은 코드 값에 병기를 붙였고, 기존 자리 하나가 함께 정리됐다.
# ⚠ 2026-09-06 — 487 → 486. `pop-계약-미착지-12건` 반영이 `P-02-10` 에서 한 자리를
#    정리했다. 같은 회차가 `P-02-06`(`ACTIVE`·`WAITING`)·`P-04-03`(`MANUAL`) 에서 세
#    자리를 병기 없이 새로 적어 489 로 올렸던 것은 이 검사기가 잡아 되돌렸다.
BASELINE_SCREEN = 486
