...
#      결손으로 적었다. ✅ **해소 2026-09-03** — `LotHoldEvent.releaseReasonCode` 를
#      계약에 신설하고 §4-B·요구서에 실었다.
#
#    ✅ `OWNERSHIP_TYPE` 2 — **판정 완료(2026-09-03 사용자): 두지 않는다.**
#      사급·수탁을 다루기는 하나 중요하게 다뤄지지 않고(사용자 판정), 사급은 «자재»
